...
var widthLess1024 = function() {
    ...
    widthLess768 = function() {
        ...
        (
            ...
            1 === $(".collapsed-content li.user").length && $(".quick-actions >li.dropdown:last-child").after($("#current-user"))
        )
    };
$(function() {
    function e(e) {
    ...
    // if ($("#mmenu").mmenu && $("#balance-chart").sparkline && $("#sales-chart").sparkline && $("#mmenu").mmenu({
    //     position: "right",
    //     zposition: "next",
    //     moveBackground: !1
    ...
    $("#mmenu").on("opened.mm", function() {
        ...
        click: function(e) {
            $(this).data("closable", !0), $(this).hasClass("open") || $("li.dropdown.open").removeClass("open"), $("#sidebar").hasClass("collapsed") && e.stopPropagation(), $("#sidebar").getNiceScroll().resize()
        },
        "hide.bs.dropdown": function() {
            return $(this).data("closable")
        }
    }), $(".sidebar-collapse a").on("click", function() {
        $("#sidebar, #navbar").toggleClass("collapsed"), $("#navigation").find(".dropdown.open").removeClass("open"), $("#navigation").find(".dropdown-menu.animated").removeClass("animated"), $("#sidebar > li.collapsed").removeClass("collapsed"), isMobile.any() ? $("#content").css($("#sidebar").hasClass("collapsed") ? {
            paddingLeft: "55px",
            display: "block"
        } : {
            paddingLeft: "265px",
        ...
        $(e.target).parent().removeClass("hovered"), $(this).removeClass("hovered"), $("#sidebar").removeClass("open")
    ...
    // Change background image by jquery. Comment because we use change background by react.
    ...
    var i = function() {
            $("body .videocontent").c('<div class="video-background video-bg-1"></div>'), $(".video-background").videobackground({
                videoSource: [
        ...
        a = function() {
            ...
            $(".video-background").videobackground({
                videoSource: [
                    ["assets/videobg/" + e + ".mp4", "video/mp4"],
                    ["assets/videobg/" + e + ".webm", "video/webm"],
                    ["assets/videobg/" + e + ".ogv", "video/ogg"]
                ],
                controlPosition: "#video",
                loop: !0,
                controlText: "",
    ...
    $("#videobackgrounds li a").click(function() {
        var e = $(this).attr("class");
        $("#video").html(""), $("body .videocontent").prepend('<div class="video-background"></div>'), $(".video-background").addClass(e), a(), $("#videobg-check").prop("checked", !0)
    }), $("#videobg-check").is(":checked") && i(), $("#videobg-check").change(function() {
        ...
        return e(n), window.setTimeout(function() {
            o(n)
        }, 1e3), !1
