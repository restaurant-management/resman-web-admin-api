    ...
    var r = function(n) {
        ...
        h.Client.prototype = {
            ...
            getHTML: function(a, b) {
                ...
                else c += '<embed id="' + this.movieId + '" src="' + h.moviePath + '" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="' + a + '" height="' + b + '" name="' + this.movieId + '" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="' +
                    d + '" wmode="transparent" />';
                return c
            },
            hide: function() {
            ...
            receiveEvent: function(a, b) {
                ...
                if (this.handlers[a])
                    for (var d = 0, e = this.handlers[a].length; d <
                        ...
                        else if ("string" == typeof f) l[f](this, b)
                    }
            }
        };
        ...
        g.prototype = {
            ...
            _fnRowSelectConfig: function() {
                if (this.s.master) {
                    ...
                    "os" === this.s.select.type && (f(b.nTBody).on("mousedown.DTTT_Select", "tr", function(a) {
                        if (a.shiftKey) f(b.nTBody).css("-moz-user-select", "none").one("selectstart.DTTT_Select",
                            "tr",
                            function() {
                                return !1
                            })
                    ...
                    f(b.nTBody).on("click.DTTT_Select", "tr", function(c) {
                        var d = a.s.select,
                            e = a.s.dt.oInstance.fnGetPosition(this);
                        if (this.parentNode == b.nTBody && b.oInstance.fnGetData(this) !== null) {
                            if (d.type == "os")
                                if (c.ctrlKey || c.metaKey) a.fnIsSelected(this) ? a._fnRowDeselect(this, c) : a._fnRowSelect(this, c);
                                else if (c.shiftKey) {
                                var g = a.s.dt.aiDisplay.slice(),
                                    m = f.inArray(d.lastRow, g),
                                    i = f.inArray(e, g);
                                if (a.fnGetSelected().length ===
                                    0 || m === -1) g.splice(f.inArray(e, g) + 1, g.length);
                                else {
                                    if (m > i) var j = i,
                                        i = m,
                                        m = j;
                                ...
                                } else a._fnRowSelect(g, c)
                            } else if (a.fnIsSelected(this) && a.fnGetSelected().length === 1) a._fnRowDeselect(this, c);
                            else {
                                a.fnSelectNone();
                                a._fnRowSelect(this, c)
                            } else if (a.fnIsSelected(this)) a._fnRowDeselect(this, c);
                            else if (d.type == "single") {
                                a.fnSelectNone();
                                a._fnRowSelect(this, c)
                            } else d.type == "multi" && a._fnRowSelect(this,
                                c);
                            d.lastRow = e
                        }
                    });
            ...
            _fnRowSelect: function(a, b) {
                var c = this._fnSelectData(a),
                    ...
                    e, o;
                e = 0;
                for (o = c.length; e < o; e++) c[e].nTr && d.push(c[e].nTr);
                if (null === this.s.select.preRowSelect || this.s.select.preRowSelect.call(this, b, d, !0)) {
                    e = 0;
                    for (o = c.length; e < o; e++) c[e]._DTTT_selected = !0, c[e].nTr && f(c[e].nTr).addClass(this.classes.select.row);
            ...
            _fnRowDeselect: function(a, b) {
                ...
                if (null === this.s.select.preRowSelect || this.s.select.preRowSelect.call(this, b, d, !1)) {
                    e = 0;
                    for (o = c.length; e < o; e++) c[e]._DTTT_selected = !1, c[e].nTr && f(c[e].nTr).removeClass(this.classes.select.row);
            ...
            _fnColumnTargets: function(a) {
                ...
                if ("object" == typeof a) {
                    ...
                    d = 0;
                    for (e = c.aoColumns.length; d < e; d++) b.push(c.aoColumns[d].bSortable ? !0 : !1)
                } else {
                    d = 0;
            ...
            _fnGetDataTablesData: function(a) {
                ...
                for (e = s.length; d < e; d++) {
                    ...
                    g = [];
                    b = 0;
                    for (c = h.aoColumns.length; b < c; b++) n[b] && (i = h.oApi._fnGetCellData(h, s[d], b, "display"), a.fnCellRender ? i = a.fnCellRender(i, b, l, s[d]) + "" : "string" == typeof i ? (i = i.replace(/\n/g, " "), i = i.replace(/<img.*?\s+alt\s*=\s*(?:"([^"]+)"|'([^']+)'|([^\s>]+)).*?>/gi,
                ...
                if (a.bFooter && null !== h.nTFoot) {
                    g = [];
                    b = 0;
                    for (c = h.aoColumns.length; b < c; b++) n[b] && null !== h.aoColumns[b].nTf && (i = h.aoColumns[b].nTf.innerHTML.replace(/\n/g,
            ...
            _fnPrintStart: function(a) {
                ...
                if ("" !== c.oScroll.sX || "" !== c.oScroll.sY) this._fnPrintScrollStart(c), f(this.s.dt.nTable).bind("draw.DTTT_Print",
                    function() {
                ...
                for (e in d)
                    if ("i" != e && "t" != e && 1 == e.length)
                        for (var g = 0, h = d[e].length; g < h; g++) this.dom.print.hidden.push({
                            node: d[e][g],
                            display: "block"
        ...
        g.fnGetMasters = function() {
            for (var a = [], b = 0, c = g._aInstances.length; b <
                c; b++) g._aInstances[b].s.master && a.push(g._aInstances[b]);
            return a
        };
        g.fnGetInstance = function(a) {
            "object" != typeof a && (a = j.getElementById(a));
            for (var b = 0, c = g._aInstances.length; b < c; b++)
                if (g._aInstances[b].s.master && g._aInstances[b].dom.table == a) return g._aInstances[b];
            return null
        };
        ...
        g.BUTTONS = {
            ...
            text: f.extend({}, g.buttonBase),
            select: f.extend({}, g.buttonBase, {
            ...
            select_single: f.extend({}, g.buttonBase, {
                sButtonText: "Select button",
                fnSelect: function(a) {
            ...
            select_none: f.extend({}, g.buttonBase, {
        ...
        "function" == typeof f.fn.dataTable && "function" == typeof f.fn.dataTableExt.fnVersionCheck && f.fn.dataTableExt.fnVersionCheck("1.9.0") ? f.fn.dataTableExt.aoFeatures.push({
            fnInit: function(a) {
                var b = a.oInit,
                    a = new g(a.oInstance, b.tableTools || b.oTableTools || {});
