...
export class InitDatabase1574350250782 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            `CREATE TABLE "delivery_bill" ("id" SERIAL NOT NULL, "createAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "prepareAt" TIMESTAMP WITH TIME ZONE, "preparedAt" TIMESTAMP WITH TIME ZONE, "shipAt" TIMESTAMP WITH TIME ZONE, "collectAt" TIMESTAMP WITH TIME ZONE, "collectValue" money, "voucherCode" character varying(20), "voucherValue" integer, "voucherIsPercent" boolean, "discountCode" character varying(20), "discountValue" integer, "rating" double precision, "note" character varying, "customerId" integer NOT NULL, "prepareById" integer, "shipById" integer, CONSTRAINT "PK_89ebb4d80c2b15dffe5cabba308" PRIMARY KEY ("id"))`,
            undefined
        );
        await queryRunner.query(
